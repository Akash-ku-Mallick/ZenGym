...
export default function TrainerProfile({setEle, user}) {
  ...
  return (
    ...
    <Box display="flex" justifyContent="space-between" alignItems="center">
      <Header title="TRAINER PROFILE" subtitle={"Complete your Profile"||"Your Profile"} />
      <Box>
         <Button
            sx={{
        ...
        <Box
          ...
          <Typography
              variant="h6"
              color={colors.grey[300]}
              sx={{ m: "0px 0px 0px 15px" }}>Experience</Typography>
            <Typography
              variant="h5"
              color={colors.grey[300]}
              sx={{ m: "0px 0px 0px 15px" }}>{"Experience"}</Typography>
          ...
          <Typography
              variant="h6"
              color={colors.grey[300]}
              sx={{ m: "0px 0px 0px 15px" }}>Work At</Typography>
            <Typography
              variant="h5"
              color={colors.grey[300]}
          ...
          <Typography
              variant="h6"
              color={colors.grey[300]}
              sx={{ m: "0px 0px 0px 15px" }}>Charges</Typography>
            <Typography
              variant="h5"
              color={colors.grey[300]}
              sx={{ m: "0px 0px 0px 15px" }}>{"Charges "}{"/Day"}</Typography>
          </Box>
          <Box
          gridColumn="span 4"
          gridRow="span 2"
