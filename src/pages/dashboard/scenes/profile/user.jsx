...
export default function UserProfile({setEle, user}) {
  ...
  return (
    ...
    <Box display="flex" justifyContent="space-between" alignItems="center">
      <Header title="USER PROFILE" subtitle={"Complete your Profile"||"Your Profile"} />
      <Box>
         <Button
            sx={{
        ...
        <Box
          ...
          <Typography
              variant="h6"
              color={colors.grey[300]}
              sx={{ m: "0px 0px 0px 15px" }}>Goals</Typography>
            <Typography
              variant="h5"
              color={colors.grey[300]}
              sx={{ m: "0px 0px 0px 15px" }}>{"Goals"}</Typography>
          ...
          <Typography
              variant="h6"
              color={colors.grey[300]}
              sx={{ m: "0px 0px 0px 15px" }}>Plan</Typography>
            <Typography
              variant="h5"
              color={colors.grey[300]}
              sx={{ m: "0px 0px 0px 15px" }}>{"Current Plan "}</Typography>
          </Box>
          <Box
          gridColumn="span 3"
          gridRow="span 2"
          ...
          <Typography
              variant="h6"
              color={colors.grey[300]}
              sx={{ m: "0px 0px 0px 15px" }}>Gym</Typography>
            <Typography
              variant="h5"
              color={colors.grey[300]}
